            ...
            <div className={menu ? "mob-nav show" : "mob-nav"}>
                <div className="right-navbar flex">
                    ...
                    <ul className="nav-ul flex">
                        ...
                        <li className="nav-li"><a href="" className="nav-link">Resources</a></li>
                    </ul>
                    <div className="nav-btn-container">
                        <button className="btn login-btn">Login</button>
                        <button className="btn sign-up-btn">Sign Up</button></div>
                </div></div>
        </div>
    )
}
